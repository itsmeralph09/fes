            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-chalkboard-teacher mr-1"></i>Manage Program</h1>
                    </div>
                ...
                <table id="myTable" class="table table-bordered nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT program_tbl.*, department_tbl.*
                                    FROM program_tbl
                                    INNER JOIN department_tbl ON program_tbl.department_id = department_tbl.department_id
                                    ORDER BY department_tbl.department_code
                            ";
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                "<tr>
                                    <td>".$num."</td>
                                    <td>".strtoupper($row['program_code'])." - ".ucwords($row['program_name'])."</td>
                                    <td>".strtoupper($row['department_code'])."</td>
                                    <td>
                                        <a href='#edit_".$row['program_id']."' class='btn btn-success btn-sm' data-toggle='modal'><i class='fa fa-pen-to-square m-1'></i>Edit</a>
                                        <a href='#delete_".$row['program_id']."' class='btn btn-danger btn-sm' data-toggle='modal'><i class='fa fa-trash m-1'></i>Delete</a>
                                    </td>
                                </tr>";
                                include('program_edit_delete_modal.php');
                            $num++;}
...
<?php include('program_add_modal.php') ?>
    ...
    $(document).ready(function () {
        $("#mod_dropdown").change(function () {
            ...
            if (selectedOption === "BSIT") {
                ...
                textareaValue = selectedOption;x
            }
