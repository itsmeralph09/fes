            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-building-columns mr-1"></i>Manage Department</h1>
                    </div>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                "<tr>
                                    ...
                                    <td>".ucwords($row['department_name'])."</td>
                                    <td>
                                        <a href='#edit_".$row['department_id']."' class='btn btn-success btn-sm' data-toggle='modal'><i class='fa fa-pen-to-square m-1'></i>Edit</a>
                                        <a href='#delete_".$row['department_id']."' class='btn btn-danger btn-sm' data-toggle='modal'><i class='fa fa-trash m-1'></i>Delete</a>
                                    </td>
                                </tr>";
                                include('department_edit_delete_modal.php');
                            $num++;}
...
<?php include('department_add_modal.php') ?>
