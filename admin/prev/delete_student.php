            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-person-walking"></i>Delete Student</h1>
                    </div>
        ...
        <div class="row">
            <div class="card col-sm-6 shadow-sm p-3" style="margin-left: auto; margin-right: auto;">
                ...
                <form method="post">
                    ...
                    <a href="manage_student.php" class="btn btn-secondary m-1"><i class="fa-solid fa-x mr-1"></i>Cancel</a>
                </div>
                </form>
