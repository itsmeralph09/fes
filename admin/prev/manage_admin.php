                ...
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-12">
                        <div class="card card-settings shadow-sm p-4">
                            ...
                            <div class="card-body">
                                <a class="btn btn-primary float-left mb-3" href="add_admin.php"><i class="fa-solid fa-plus mr-1"></i>New</a>
                                <form class="settings-form">
                                    <div class="mb-3">
                                        ...
                                        <tbody>
                                                ...
                                                $sql = "SELECT * FROM admin_tbl ORDER BY date_created DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href='view_admin.php?admin_id=<?php echo $row['admin_id']; ?>'><i class='fa fa-up-right-and-down-left-from-center text-primary m-1'></i></a>
                                                        <a href='?=edit'><i class='fa fa-pen-to-square text-success m-1'></i></a>
                                                        <a href='delete_admin.php?admin_id=<?php echo $row['admin_id']; ?>'><i class='fa fa-trash text-danger m-1'></i></a>
                                                    </td>
                                                </tr>
