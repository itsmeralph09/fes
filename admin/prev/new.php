...
<!-- new css -->
    ...
    <link rel="stylesheet" href="../assets/bootstrap-5.3.0-dist/bootstrap-5.3.0-dist/css/bootstrap.min.css">

<!-- datatables bootstrap -->
    <link rel="stylesheet" href="https://cdn.datatables.net/1.10.18/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="../assets/DataTablesRap/DataTables-1.13.4/dataTables.bootstrap.min.css">


    <!-- Custom fonts for this template-->
    <link href="../assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="../assets/fontawesome-free-6.4.0-web/css/all.min.css" rel="stylesheet" type="text/css">
    <link
    ...
    <script src="../assets/fontawesome-free-6.4.0-web/js/all.min.js" crossorigin="anonymous"></script>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                "<tr>
                                    ...
                                    <td>".$class."</td>
                                    <td>
                                        <a href='#edit_".$row['student_id']."' class='btn btn-success btn-sm' data-toggle='modal'><i class='fa fa-pen-to-square m-1'></i>Edit</a>
                                        <a href='#delete_".$row['student_id']."' class='btn btn-danger btn-sm' data-toggle='modal'><i class='fa fa-trash m-1'></i>Delete</a>
                                    </td>
                                </tr>";
...
<?php include('student_add_modal.php') ?>
    ...
    <script src="../assets/bootstrap-5.3.0-dist/bootstrap-5.3.0-dist/js/bootstrap.min.js"></script>
    ...
    <script src="../assets/DataTablesRap/DataTables-1.13.4/js/jquery.dataTables.min.js"></script>

    <script src="https://cdn.datatables.net/1.10.18/js/dataTables.bootstrap4.min.js"></script>
    <script src="../assets/DataTablesRap/DataTables-1.13.4/js/dataTables.bootstrap4.min.js"></script>

    <script src="https://cdn.datatables.net/responsive/2.4.1/js/dataTables.responsive.min.js"></script>
    <script src="../assets/DataTablesRap/Responsive-2.4.1/js/dataTables.responsive.min.js"></script>
