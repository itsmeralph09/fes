            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-person-chalkboard mr-2"></i>View Faculty</h1>
                    </div>
            ...
            <div class="card col-sm-6 shadow-sm p-3" style="margin-left: auto; margin-right: auto;">
                ...
                <form method="post">
                    <div class="mb-3">
                        ...
                        <p class="text-dark font-weight-bolder">Date Created: <span class="text-dark font-weight-normal ml-1"><?php echo $row2['date_created']; ?></p>
                    </div>
                    
                    <!-- <p class="text-danger"><strong>Are you sure you want to delete this user?</strong></p> -->
                    <div class="float-right">

                    <a href="manage_admin.php" class="btn btn-primary m-1"><i class='fa fa-pen-to-square mr-1'></i>Edit</a>
                    <a href="manage_admin.php" class="btn btn-secondary m-1"><i class="fa-solid fa-x mr-1"></i>Back</a>
                </div>
                </form>
