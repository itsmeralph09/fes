            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-person-chalkboard mr-2"></i>Manage Faculty</h1>
                    </div>
                ...
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-12">
                        <div class="card card-settings shadow-sm p-4">
                            ...
                            <div class="card-body">
                                <a class="btn btn-primary float-left mb-3" href="add_faculty.php"><i class="fa-solid fa-plus mr-1"></i>New</a>
                                <form class="settings-form">
                                    <div class="mb-3">
                                        ...
                                        <tbody>
                                                ...
                                                $sql = "SELECT * FROM faculty_tbl ORDER BY date_created DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href='view_faculty.php?faculty_id=<?php echo $row['faculty_id']; ?>'><i class='fa fa-up-right-and-down-left-from-center text-primary m-1'></i></a>
                                                        <a href='?=edit'><i class='fa fa-pen-to-square text-success m-1'></i></a>
                                                        <a href='delete_faculty.php?faculty_id=<?php echo $row['faculty_id']; ?>'><i class='fa fa-trash text-danger m-1'></i></a>
                                                    </td>
                                                </tr>
