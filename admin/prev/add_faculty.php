...
if (isset($_POST['submit'])) {
    ...
    $confirm_password = $_POST['confirm_password'];
        ...
        if ($password == $confirm_password) {
            ...
            $query = "INSERT INTO faculty_tbl(school_id, first_name, middle_name, last_name, email) VALUES ('$school_id', '$first_name', '$middle_name', '$last_name', '$email')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-person-chalkboard mr-2"></i>Add Faculty</h1>
                    </div>
            ...
            <?php } ?> 
                            ...
                            <div class="card-body">
                                ...
                                <form class="settings-form" method="post" action="add_faculty.php">
                                    <div class="mb-3 row">
                                    ...
                                    <a type="submit" class="btn btn-secondary" href="manage_faculty.php"><i class="fa-solid fa-x mr-1"></i>Cancel</a>
                                    </div>
                                </form>
