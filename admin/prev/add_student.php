...
if (isset($_POST['submit'])) {
    ...
    $confirm_password = $_POST['confirm_password'];
        ...
        if ($password == $confirm_password) {
            ...
            $query = "INSERT INTO student_tbl(school_id, first_name, middle_name, last_name, class_id, email) VALUES ('$school_id', '$first_name', '$middle_name', '$last_name', '$class_id', '$email')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-person-walking"></i>Add Student</h1>
                    </div>
            ...
            <?php } ?> 
                            ...
                            <div class="card-body">
                                ...
                                <form class="settings-form" method="post" action="add_student.php">
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-4"><label for="setting-input-3" class="form-label text-dark">Class</label></div>
                                        <div class="col"><input type="text" class="form-control form-control" id="setting-input-2" name="class_id"  value="<?php echo $class_id; ?>" required></div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <a type="submit" class="btn btn-secondary" href="manage_student.php"><i class="fa-solid fa-x mr-1"></i>Cancel</a>
                                </div>
                                </form>
