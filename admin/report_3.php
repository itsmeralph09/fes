            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"> <i class="fas fa-fw fa-chart-pie mr-1"></i>Evaluation Report - Faculty Summarized</h1>
                    </div>
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                "<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='report_faculty_2.php?acad_id=".$row['acad_id']."' class='btn btn-sm btn-success' data-toggle='modal'><i class='fa fa-eye m-1'></i>View</a>
