            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-sticky-note mr-1"></i>Manage Course</h1>
                    </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            ...
            <div class="container mb-3 mt-3">
                <p class="card-title text-danger">List of courses for each academic year and semester</p>
            </div>
            <hr>
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                "<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='course.php?acad_id=".$row['acad_id']."' class='btn btn-primary btn-sm'><i class='fa fa-sliders m-1'></i>Manage</a>
