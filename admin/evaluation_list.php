            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"> <i class="fas fa-fw fa-chart-bar mr-1"></i>Submitted Evaluation</h1>
                    </div>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                $acad_id = $row['acad_id'];
                                $sql2 = "SELECT * FROM acad_yr_tbl WHERE acad_id = '$acad_id'";
                                ...
                                "<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='submitted_evaluation.php?acad_id=".$row['acad_id']."' class='btn btn-sm btn-success' data-toggle='modal'><i class='fa fa-eye m-1'></i>View</a>
