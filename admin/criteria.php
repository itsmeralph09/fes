            ...
            <div id="content">
                ...
                <div class="container-fluid justify-content-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 mb-0 text-gray-800"><i class="fas fa-fw fa-tasks mr-1"></i>Manage Criteria</h1>
                    </div>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                "<tr>
                                    ...
                                    <td>".$row['criteria']."</td>
                                    <td>
                                        <a href='#edit_".$row['criteria_id']."' class='btn btn-success btn-sm' data-toggle='modal'><i class='fa fa-pen-to-square m-1'></i>Edit</a>
                                        <a href='#delete_".$row['criteria_id']."' class='btn btn-danger btn-sm' data-toggle='modal'><i class='fa fa-trash m-1'></i>Delete</a>
                                    </td>
                                </tr>";
                                include('criteria_edit_delete_modal.php');
                            $num++;}
...
<?php include('criteria_add_modal.php') ?>
